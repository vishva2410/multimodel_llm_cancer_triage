...
class PerceptionService:
    def predict(self, image_data: bytes, cancer_type: str) -> PerceptionOutput:
        # Seed random number generator with image checksum for deterministic results
        # This ensures consistent predictions for the same image, enabling caching downstream
